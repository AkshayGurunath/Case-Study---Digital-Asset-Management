...
//        public AssetManagementServiceImpl(SqlConnection connection)
//        {
...
//            // Using a using statement for connection management
//            using (SqlConnection connection = new SqlConnection(this.connection.ConnectionString))
//            {
//                string query = "INSERT INTO assets (name, type, serial_number, purchase_date, location, status, owner_id) VALUES (@name, @type, @serial_number, @purchase_date, @location, @status, @owner_id)";
//                using (SqlCommand cmd = new SqlCommand(query, connection))
//                {
//                    cmd.Parameters.AddWithValue("@name", asset.Name);
//                    cmd.Parameters.AddWithValue("@type", asset.Type);
...
//            public bool UpdateAsset(Asset asset)
//        {
//            // Implementation for updating an asset in the database
//            try
//            {
//                string query = "UPDATE assets SET name=@name, type=@type, serial_number=@serial_number, purchase_date=@purchase_date, location=@location, status=@status, owner_id=@owner_id WHERE asset_id=@asset_id";
//                using (SqlCommand cmd = new SqlCommand(query, connection))
...
//        public bool DeleteAsset(int assetId)
//        {
//            // Implementation for deleting an asset from the database
//            try
//            {
//                string query = "DELETE FROM assets WHERE asset_id=@asset_id";
//                using (SqlCommand cmd = new SqlCommand(query, connection))
...
//        {
//            // Implementation for allocating an asset to an employee
//            try
//            {
//                string query = "INSERT INTO asset_allocations (asset_id, employee_id, allocation_date) VALUES (@asset_id, @employee_id, @allocation_date)";
//                using (SqlCommand cmd = new SqlCommand(query, connection))
//                {
//                    cmd.Parameters.AddWithValue("@asset_id", assetId);
//                    cmd.Parameters.AddWithValue("@employee_id", employeeId);
...
//        public bool DeallocateAsset(int assetId, int employeeId, string returnDate)
//        {
//            // Implementation for deallocating an asset from an employee
//            try
//            {
//                string query = "UPDATE asset_allocations SET return_date=@return_date WHERE asset_id=@asset_id AND employee_id=@employee_id";
//                using (SqlCommand cmd = new SqlCommand(query, connection))
...
//        public bool PerformMaintenance(int assetId, string maintenanceDate, string description, double cost)
//        {
//            // Implementation for performing maintenance on an asset
//            try
//            {
//                string query = "INSERT INTO maintenance_records (asset_id, maintenance_date, description, cost) VALUES (@asset_id, @maintenance_date, @description, @cost)";
//                using (SqlCommand cmd = new SqlCommand(query, connection))
//                {
//                    cmd.Parameters.AddWithValue("@asset_id", assetId);
//                    cmd.Parameters.AddWithValue("@maintenance_date", maintenanceDate);
...
//        public bool ReserveAsset(int assetId, int employeeId, string reservationDate, string startDate, string endDate)
//        {
//            // Implementation for reserving an asset
//            try
//            {
//                string query = "INSERT INTO reservations (asset_id, employee_id, reservation_date, start_date, end_date, status) VALUES (@asset_id, @employee_id, @reservation_date, @start_date, @end_date, 'Pending')";
//                using (SqlCommand cmd = new SqlCommand(query, connection))
//                {
//                    cmd.Parameters.AddWithValue("@asset_id", assetId);
//                    cmd.Parameters.AddWithValue("@employee_id", employeeId);
...
//        public bool WithdrawReservation(int reservationId)
//        {
//            // Implementation for withdrawing a reservation
//            try
//            {
//                string query = "DELETE FROM reservations WHERE reservation_id=@reservation_id";
//                using (SqlCommand cmd = new SqlCommand(query, connection))
